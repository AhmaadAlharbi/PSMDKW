    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('engineer.update',['id' => $engineer->id])}}" enctype="multipart/form-data"
                    method="post" autocomplete="off">
                    @csrf
                    <div class="modal-body">
                        <label for="eng_name" class="control-label ">اسم المهندس</label>
                        <input type="text" name="eng_name" class="form-control m-2" value="{{$engineer->name}}">
                        <label for="email" class="control-label ">البريد الإلكتروني</label>
                        <input type="text" name="email" class="form-control m-2" value="{{$engineer->email}}">
                        <label for="mobile" class="control-label ">الهاتف </label>
                        <input type="text" name="mobile" class="form-control m-2" value="{{$engineer->mobile}}">
                        <label for="area_id" class="control-label ">المنطقة</label>
                        <select name="area_id" id="area" class="form-control">
                            <!--placeholder-->
                            @if($engineer->area_id == "1")
                    ...
                    <div class="modal-footer">
                        <a href="{{route('engineer.list')}}" type="button" class="btn btn-secondary"
