                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='10'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$engineer->area->area_name}}</td>
                                <td>{{$engineer->shift->shift_name}}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item"
                                                href="{{route('engineer.edit',['id'=>$engineer->id])}}">تعديل</a>
                                            <form action="{{route('engineer.destroy',['id'=>$engineer->id])}}"
                                                method="POST"> @csrf
                                                @method('delete');
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('engineer.add')}}" method="POST">
                @csrf
